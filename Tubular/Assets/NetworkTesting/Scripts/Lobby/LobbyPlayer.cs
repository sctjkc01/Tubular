/*
 * This script collects data for the player. 
 * So if you need a color, you can have them select it here
 * or other data as needed
 * 
 * it took me hours to really understand all these scripts and how they work together
 * so take an afternoon, and follow the code - this is how i like to come to understand somebody's code:
 * just think about where the process starts, and follow what script goes where 
 * 
 * and that process becomes harder to follow when it's networked
 * I'll send this file witl comments 
 * but you'll need to just spend time on it before you change anything 
 * 
 * */
...
namespace UnityStandardAssets.Network
{
	...
	public class LobbyPlayer : NetworkLobbyPlayer
	{
		...
		public void OnColorClicked ()
		{
			...
			// every time you click the button it changes to next color in an array
			// then it calls a command for the server
			CmdColorChange (idx);
		}
